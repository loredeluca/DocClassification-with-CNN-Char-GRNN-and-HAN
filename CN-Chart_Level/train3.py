...
from prep3 import CN_ChartDataset
from model3 import CharacterLevelCNN
from utils3 import get_evaluation, save_checkpoint
...
if __name__ == "__main__":
    data_folder = "./datasets/ag_news_csv"
